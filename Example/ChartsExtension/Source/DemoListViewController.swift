...
class DemoListViewController: UIViewController {
    ...
    private var itemDefs = [
                    ...
                    ItemDef(title: "Exam Chart type 1",
                            subtitle: "A simple demonstration of the linechart.",
                            class: ExamChartViewController.self),
                    ItemDef(title: "Exam Chart type 2",
                            subtitle: "A simple demonstration of the linechart.",
                            class: ExamChartViewController.self),
                    ItemDef(title: "Exam Chart type 3",
                            subtitle: "A simple demonstration of the linechart.",
                            class: ExamChartViewController.self),
                    ItemDef(title: "Exam Chart type 4",
                            subtitle: "A simple demonstration of the linechart.",
                            class: ExamChartViewController.self),
                    ItemDef(title: "BGM Chart",
                            subtitle: "A simple demonstration of the linechart.",
                            class: LifeCareChartViewController.self),
                    ItemDef(title: "BPM chart",
                            subtitle: "A simple demonstration of the linechart.",
                            class: LifeCareChartViewController.self),
                    ...
                    ItemDef(title: "Bar Chart EXAM",
                            subtitle: "A simple demonstration of the bar chart.",
                            class: ExamBarChartViewController.self),
                    ItemDef(title: "Bar Chart BGM",
                            subtitle: "A simple demonstration of the bar chart.",
                            class: BGMBarChartViewController.self),
...
extension DemoListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = vcClass.init()
        if vc.isKind(of: ExamChartViewController.self) {
            (vc as? ExamChartViewController)?.chartType = indexPath.row + 1
        } else if vc.isKind(of: LifeCareChartViewController.self) {
            (vc as? LifeCareChartViewController)?.isBGMChart = indexPath.row == 4
        }
