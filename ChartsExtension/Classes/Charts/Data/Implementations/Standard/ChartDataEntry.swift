...
open class ChartDataEntry: ChartDataEntryBase, NSCopying
{
    ...
    @objc public convenience init(x: Double, y: Double, icon: NSUIImage?, iconHighlight: NSUIImage?, data: Any?)
    {
        self.init(x: x, y: y)
        self.icon = icon
    ...
    @objc public convenience init(x: Double, y: Double, icon: NSUIImage?, iconHighlight: NSUIImage?, colorHighlight: NSUIColor?, data: Any?)
    {
        self.init(x: x, y: y)
        self.icon = icon
        self.iconHighlight = iconHighlight
