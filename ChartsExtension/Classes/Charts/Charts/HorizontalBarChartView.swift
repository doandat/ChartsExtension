...
open class HorizontalBarChartView: BarChartView
{
    internal override func initialize()
    {
        ...
        leftYAxisRenderer = YAxisRendererHorizontalBarChart(viewPortHandler: _viewPortHandler, yAxis: leftAxis, transformer: _leftAxisTransformer, arrValueYAxis: [ChartYValueCustom]())
        rightYAxisRenderer = YAxisRendererHorizontalBarChart(viewPortHandler: _viewPortHandler, yAxis: rightAxis, transformer: _rightAxisTransformer, arrValueYAxis: [ChartYValueCustom]())
