...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    @objc open lazy var leftYAxisRenderer = YAxisRenderer(viewPortHandler: _viewPortHandler, yAxis: leftAxis, transformer: _leftAxisTransformer, arrValueYAxis: leftAxis.arrValueYAxis)

    /// The right Y axis renderer. This is a read-write property so you can set your own custom renderer here.
    /// **default**: An instance of YAxisRenderer
    @objc open lazy var rightYAxisRenderer = YAxisRenderer(viewPortHandler: _viewPortHandler, yAxis: rightAxis, transformer: _rightAxisTransformer,arrValueYAxis: rightAxis.arrValueYAxis)
    ...
    @objc open lazy var xAxisRenderer = XAxisRenderer(viewPortHandler: _viewPortHandler, xAxis: _xAxis, transformer: _leftAxisTransformer, circleRadius: _xAxis.circleRadius, circleColor: _xAxis.circleColor, drawCirclesEnabled: _xAxis.drawCirclesEnabled, extendRightAreaEnabled: _xAxis.extendRightAreaEnabled, disableZeroValue: _xAxis.disableZeroValue)
