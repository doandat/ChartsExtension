...
open class XAxisRendererRadarChart: XAxisRenderer
{
    ...
    {
        super.init(viewPortHandler: viewPortHandler, xAxis: xAxis, transformer: nil, circleRadius: 3.0, circleColor: NSUIColor.gray, drawCirclesEnabled: false, extendRightAreaEnabled: false, disableZeroValue: false)
