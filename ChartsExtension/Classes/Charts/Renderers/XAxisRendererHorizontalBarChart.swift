...
open class XAxisRendererHorizontalBarChart: XAxisRenderer
{
    ...
    {
        super.init(viewPortHandler: viewPortHandler, xAxis: xAxis, transformer: transformer, circleRadius: 3.0, circleColor: NSUIColor.gray, drawCirclesEnabled: false, extendRightAreaEnabled: false, disableZeroValue: false)
