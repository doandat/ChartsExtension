...
{
    public override init(viewPortHandler: ViewPortHandler, yAxis: YAxis?, transformer: Transformer?, arrValueYAxis: [ChartYValueCustom])
    {
        super.init(viewPortHandler: viewPortHandler, yAxis: yAxis, transformer: transformer, arrValueYAxis: arrValueYAxis)
    }
